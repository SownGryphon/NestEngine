...
namespace Nest
{
	...
	{
		m_VPM = chcl::Mat4::RotationXY(-chcl::toRadians(m_rotation)) * chcl::Mat4::Ortho(m_pos.x - m_size.x / 2, m_pos.x + m_size.x / 2, m_pos.y - m_size.y / 2, m_pos.y + m_size.y / 2, -1.f, 1.f);
	}
